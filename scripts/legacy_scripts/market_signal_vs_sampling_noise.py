...
def subset_prices(price_df: pd.DataFrame, tickers: list[str]) -> pd.DataFrame:
    return price_df[price_df.index.get_level_values("ticker").isin(set(tickers))]
...
if __name__ == "__main__":
    ...
    print("\n############ FULL PANEL ############")
    full = run_analysis(prices, price_col="close", out_prefix="rmt")

    # greedy correlated / uncorrelated ticker groups from the full corr matrix
    returns = panel_to_returns(prices, "close")
    ...
    print("\n############ CORRELATED GROUP ############")
    run_analysis(subset_prices(prices, corr_group), price_col="close",
                 out_prefix="rmt_correlated")

    print("\n############ UNCORRELATED GROUP ############")
    run_analysis(subset_prices(prices, uncorr_group), price_col="close",
                 out_prefix="rmt_uncorrelated")
